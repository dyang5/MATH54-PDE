...
Plugging in our solution for $u(x, t)$ when $t > 0$ into the left-hand side of the equation, we have that
...
&= 2 \int_{-\infty}^{\infty} e^{-y^2} \, dy.\end{align*}
