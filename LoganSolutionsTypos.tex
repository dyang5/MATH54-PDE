...
\begin{document}
	...
	\hrule
	\begin{center}
		{\Large Typos in Logan's \textit{Applied Partial Differential Equations, 3rd ed} Solutions } \\ % Replace with the homework number
		\vspace{0.2cm}
		Spring 2023 \hfill David Yang% Replace with your name(s)
	\end{center}
